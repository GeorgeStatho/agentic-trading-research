...
def build_manager_prompt(
    ...
    *,
    ...
    default_system_prompt = (
        ...
        "If the article and research evidence is strong, fresh, specific, and internally consistent, prefer that evidence over ordinary one-day market noise or broad volatility. "
        ...
        "Use the live market context primarily to judge timing, tradability, current risk, and account constraints. "
        "When volatility context is present, use it as a coarse timing and tradeability signal rather than as a proprietary production model. "
        "Do not let a weak daily move by itself overturn a convincing bullish or bearish evidence-based thesis unless the live context clearly signals a meaningful contradiction or an unacceptably risky setup. "
        ...
        "Prefer 'neither' when evidence is weak, stale, contradictory, directionally unclear, timing is unclear, or account constraints make the trade unattractive. "
