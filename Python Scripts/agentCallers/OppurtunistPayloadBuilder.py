...
def _find_sector(sector_identifier: str) -> dict[str, Any] | None:
...
def build_opportunist_input(
    ...
    *,
    ...
    sector_news = get_sector_rss_news(
        sector_identifier,
        start_time=start_time,
        end_time=end_time,
        max_age_days=max_age_days,
    )
    macro_news = get_high_confidence_macro_news_for_sector(
        sector_identifier,
        start_time=start_time,
        end_time=end_time,
        max_age_days=max_age_days,
    ...
    return {
        ...
        "sector_rss_news": sector_news,
        "related_macro_news": macro_news,
    }
