...
DEFAULT_OPTION_TRAIL_PROTECTION_TRIGGER_PCT = _load_env_float("OPTION_TRAIL_PROTECTION_TRIGGER_PCT", 0.40)
DEFAULT_OPTION_TRAIL_INITIAL_FLOOR_PCT = _load_env_float("OPTION_TRAIL_INITIAL_FLOOR_PCT", 0.10)
DEFAULT_OPTION_TRAIL_FIRST_SCALE_OUT_TRIGGER_PCT = _load_env_float(
    "OPTION_TRAIL_FIRST_SCALE_OUT_TRIGGER_PCT",
    0.55,
)
DEFAULT_OPTION_TRAIL_FIRST_SCALE_OUT_FRACTION = _load_env_float(
    "OPTION_TRAIL_FIRST_SCALE_OUT_FRACTION",
    0.50,
)
DEFAULT_OPTION_TRAIL_SECOND_SCALE_OUT_TRIGGER_PCT = _load_env_float(
    "OPTION_TRAIL_SECOND_SCALE_OUT_TRIGGER_PCT",
    2.00,
)
DEFAULT_OPTION_TRAIL_SECOND_SCALE_OUT_FRACTION = _load_env_float(
    "OPTION_TRAIL_SECOND_SCALE_OUT_FRACTION",
    0.25,
)
DEFAULT_OPTION_TRAIL_3_7_GIVEBACK_PCT = _load_env_float("OPTION_TRAIL_3_7_GIVEBACK_PCT", 0.25)
DEFAULT_OPTION_TRAIL_7_14_GIVEBACK_PCT = _load_env_float("OPTION_TRAIL_7_14_GIVEBACK_PCT", 0.35)
DEFAULT_OPTION_TRAIL_14_30_GIVEBACK_PCT = _load_env_float("OPTION_TRAIL_14_30_GIVEBACK_PCT", 0.45)
DEFAULT_OPTION_TRAIL_100_FLOOR_PCT = _load_env_float("OPTION_TRAIL_100_FLOOR_PCT", 0.60)
DEFAULT_OPTION_TRAIL_150_FLOOR_PCT = _load_env_float("OPTION_TRAIL_150_FLOOR_PCT", 1.00)
DEFAULT_OPTION_TRAIL_200_FLOOR_PCT = _load_env_float("OPTION_TRAIL_200_FLOOR_PCT", 1.40)
DEFAULT_OPTION_PENDING_EXIT_STALE_MINUTES = _load_env_float("OPTION_PENDING_EXIT_STALE_MINUTES", 10.0)
